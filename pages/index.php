        ...
        <div class="container">
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <a href="/pages/inicio.php" class="btn"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="card">
                    ...
                    <a href="/pages/propiedades.php" class="btn"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="4" y="2" width="16" height="20" rx="2" ry="2" />
                            <rect x="9" y="6" width="6" height="4" />
                            <path d="M9 18h6" />
                            <path d="M9 14h6" />
                        </svg> Ir a Propiedades</a>
                </div>
                <div class="card">
                    <h2>Interacciones</h2>
                    <p>Visualiza métricas, KPIs y estadísticas relacionadas con las interacciones de agentes y clientes.</p>
                    <a href="/pages/interacciones.php" class="btn"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                        </svg> Ir a Interacciones</a>
                </div>
            </div>
        </div>
    </main>
